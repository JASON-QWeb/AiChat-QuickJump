...
export const messages = {
  'zh-CN': {
    ...
    'options.shortcuts.not_set': '未设置',
    'options.shortcuts.edit': '打开快捷键设置',
    'options.shortcuts.custom.hint': '点击下方按钮可打开 Chrome 快捷键设置页面',
  ...
  'en': {
    ...
    'options.shortcuts.toggle.desc': 'Mac: Option (⌥) + D | Win: Alt + D',
    'options.shortcuts.not_set': 'Not set',
    'options.shortcuts.edit': 'Open Shortcuts Settings',
    'options.shortcuts.custom.hint': 'Click the button below to open Chrome shortcuts settings',
